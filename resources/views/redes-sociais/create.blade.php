...
<div class="container-fluid"> 
    <div class="row"> 
            ...
            <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel"> 
                ...
                <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto"> 
                    <ul class="nav flex-column"> 
                        ...
                        <li class="nav-item"> 
                            <a class="nav-link d-flex align-items-center gap-2" href="{{ route('redes-sociais.create') }}"> 
                                <svg class="bi" aria-hidden="true">
                                    <use xlink:href="#cart"></use>
                                </svg>
                            Novo
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4"> 
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom"> 
                    <h1 class="h2">Criar Rede Social</h1> 
            ...
            <div class="col-md 12">
                ...
                <form action=" {{ route('redes-sociais.store')}}" method='post' enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input type="url" name="link" placeholder="URL da Rede Social" class="form-control mb-3">
                    </div>
                    
                    <div class="form-group">
                        <input type="text" name="video" placeholder="Codigo do vídeo" class="form-control mb-3">
                    </div>
    ...
    <script src="dashboard.js" class="astro-vvvwv3sm"></script> </body> 
</html>